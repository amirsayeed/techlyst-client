...
const MyProfile = () => {
  ...
  return (
    <div className="flex flex-col justify-center max-w-xs mx-auto mt-10 p-6 shadow-md rounded-xl sm:px-12 bg-base-100 text-base-content">
      <img
      ...
      <div className="space-y-4 text-center divide-y divide-base-300">
        ...
        <div className="pt-4">
          {!dbUser?.subscribed ? (
            ...
            <span className="inline-block badge badge-success text-white px-4 py-2 mt-2 text-sm">
